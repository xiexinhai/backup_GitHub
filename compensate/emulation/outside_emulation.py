...
if __name__ == "__main__":
    ...
    try:
        ...
        ##comm.SetOverVoltageProtection(18)

        #comm2.SetCurrent(0.)
        #comm2.Output("ON")
        ##comm2.SetOverCurrentProtection(5.0)
        ##comm2.SetOverVoltageProtection(18)

        #comm3.SetCurrent(0.)
        #comm3.Output("ON")
        ##comm3.SetOverCurrentProtection(5.0)
        ##comm3.SetOverVoltageProtection(18)
        ...
        while True:
            ...
            if check_safety(deltaBx,deltaBy,deltaBz,T1,T2,Ix,Iy,Iz) == False:
                triggerPrint = True
                break
